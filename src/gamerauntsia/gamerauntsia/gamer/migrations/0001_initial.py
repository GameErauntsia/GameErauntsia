        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "telegram_id",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Telegram kodea"
                    ),
                ),
                ...
                (
                    "signature",
                    models.TextField(
                        blank=True, null=True, verbose_name="Foro sinadura"
                    ),
                ),
                (
                    "devices",
                    models.TextField(
                        blank=True, null=True, verbose_name="Mugikor gailuaen IDak"
                    ),
                ),
                (
                    "ytube_channel",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=150,
                        null=True,
                        verbose_name="Twitch kanala",
                    ),
                ),
                (
                    "email_notification",
                    models.BooleanField(default=True, verbose_name="Eztabaidak"),
                ),
                (
                    "buletin_notification",
                    models.BooleanField(default=True, verbose_name="Buletinak"),
                ),
                (
                    "motherboard",
                    models.CharField(
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=150,
                        null=True,
                        verbose_name="Bigarren disko gogorra",
                    ),
                ),
                (
                    "mouse",
                    models.CharField(
                        blank=True, max_length=150, null=True, verbose_name="Sagua"
                    ),
                ),
                (
                    "keyboard",
                    models.CharField(
                        blank=True, max_length=150, null=True, verbose_name="Teklatua"
                    ),
                ),
                (
                    "speakers",
