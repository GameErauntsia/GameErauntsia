...
# import serializers
from gamerauntsia.app.authentication.serializers import (
    UsersListSerializer,
                    ...
                    return Response(
                        {
                            ...
                            + str(getattr(self.object, self.lookup_field))
                            + "/",
                        },
...
class UsersViewSet(CustomModelViewSet):
    ...
    def create(self, *args, **kwargs):
        return Response(
            {"message": "Invalid Request"}, status=status.HTTP_405_METHOD_NOT_ALLOWED
        )
