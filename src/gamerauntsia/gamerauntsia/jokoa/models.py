...
class Garatzailea(models.Model):
    ...
    desk = models.TextField(
        max_length=256, null=True, blank=True, verbose_name="Deskribapena"
    )
...
class Jokoa(models.Model):
    ...
    logoa = models.ForeignKey(Photo, on_delete=models.PROTECT)
    karatula = models.ForeignKey(
        Photo, on_delete=models.PROTECT, blank=True, null=True, related_name="karatula"
    )
    ...
    trailer = models.CharField(
        ...
        null=True,
        blank=True,
        verbose_name="Youtube trailerra",
    ...
    url = models.CharField(
        max_length=64,
        help_text="Eremu honetan joko honen atariko URL helbidea zehazten ari zara.",
    )
