...
DEFAULT_FROM_EMAIL = 'Game Erauntsia <email@domain.com>'
BULETIN_FROM_EMAIL = 'Game Erauntsia <email@domain.com>'
SERVER_EMAIL = DEFAULT_FROM_EMAIL
EMAIL_SUBJECT_PREFIX = '[Game Erauntsia] '
DEFAULT_TO_EMAIL = 'Game Erauntsia <email@domain.com>'
EMAIL_SUBJECT = '[Game Erauntsia]'

ADMINS = (
    ('Admin name', 'yourmail@domain.com'),
)
...
GP_GROUP = '' #Set your GamePlay editor group name
NEWS_GROUP = '' #Set your blog editor group name
