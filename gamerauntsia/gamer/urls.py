...
urlpatterns = [
    ...
    re_path(
        r"^editatu-profil-jakin$", views.edit_notifications, name="edit_profile_noti"
    ),
    re_path(
    ...
    re_path(
        r"^edit-profile-photo$", views.edit_profile_photo, name="edit_profile_photo"
    ),
    re_path(
        r"^editatu-profil-kanalak", views.edit_channels, name="edit_profile_kanalak"
    ),
