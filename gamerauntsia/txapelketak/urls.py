...
urlpatterns = patterns('',
    ...
    url(r'^(?P<slug>[-\w]+)/taldea/gehitu-taldea$', 'gamerauntsia.txapelketak.views.sortu_taldea', name='sortu_taldea'),
    url(r'^(?P<slug>[-\w]+)/taldea/(?P<part_id>[-\w]+)$', 'gamerauntsia.txapelketak.views.partaidea', name='partaidea'),
)
